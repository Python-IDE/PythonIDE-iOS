...
def bind(state: Union[State, ReactiveState], field_name: str, *,
         parse: Optional[Callable[[Any], Any]] = None,
         format: Optional[Callable[[Any], Any]] = None,
         validate: Optional[Callable[[Any], bool]] = None) -> Dict[str, Any]:
    ...
    Optional, backward-compatible hooks:
    - ``parse``: ``incoming -> stored`` transform before write-back (rejects
      the write if it raises).
    - ``format``: ``stored -> display`` transform when reading.
    - ``validate``: ``incoming -> bool`` guard; falsy rejects the write.
    """
    ...
...
class View:
    ...
    def sheet(self, is_presented: bool = False, content: Optional[Union["View", Callable[[], "View"]]] = None,
        ...
        Do not conditionally wrap ``root.sheet(...)`` in ``if state.show_x``.
...
class Button(View):
    ...
    Example::
        ...
        # Title + SF Symbol without a custom content view:
        appui.Button("收藏", action=bookmark, system_image="bookmark")
        # Icon-only button:
        appui.Button(action=refresh, system_image="arrow.clockwise")
    """
    def __init__(self, title: Optional[Union[str, View]] = None, action: Optional[Callable] = None,
                 role: Optional[str] = None, content: Optional[ViewChild] = None,
                 system_image: Optional[str] = None, image: Optional[str] = None,
...
class Menu(View):
    ...
    Pass ``system_image`` (an SF Symbol name) to show an icon as the menu's
    trigger instead of text — e.g. an ``ellipsis.circle`` overflow button in a
    toolbar. When both ``title`` and ``system_image`` are given the trigger
    shows an icon + text label; with only ``system_image`` it shows the icon
    alone.
    ...
    Example::
        ...
        # Icon-only overflow menu (e.g. in a toolbar)
        appui.Menu(system_image="ellipsis.circle", content=[
            appui.Button("全部", action=show_all),
...
class Tab(View):
    ...
    def __init__(self, title: str = '', system_image: Optional[str] = None,
                 ...
                 systemImage: Optional[str] = None, role: Optional[str] = None,
...
class Section(_ContainerView):
    ...
    def __init__(self, header: Union[str, View], content: Optional[ViewChild] = None,
                 footer: Optional[Union[str, View]] = None,
                 key: Optional[str] = None) -> None: ...
    @overload
    def __init__(self, content: Optional[ViewChild] = None, *, header: Optional[Union[str, View]] = None,
                 footer: Optional[Union[str, View]] = None, children: Optional[ViewChild] = None,
                 key: Optional[str] = None) -> None: ...
...
def presentation_present(field_name: str, *, state: Optional[Union[State, ReactiveState]] = None, value: bool = True) -> bool:
    """Present a registered sheet/alert by its ``show_*`` state field."""
    ...

def presentation_dismiss(field_name: str, *, state: Optional[Union[State, ReactiveState]] = None) -> bool:
    """Dismiss a registered presentation by its ``show_*`` state field."""
    ...

def presentation_dismiss_all(*, state: Optional[Union[State, ReactiveState]] = None) -> bool:
    """Dismiss every currently presented registered slot (alias: ``dismiss_all``)."""
    ...

def dismiss_all(*, state: Optional[Union[State, ReactiveState]] = None) -> bool:
